...
本目录（`harness-scripts/`）是 top-down 按文章 6 维硬切的产物。**已被 bottom-up 计划替代**。
...
- `epic.md` — 业务诉求描述
- `tech-roadmap.md` — file:line 级插桩点 + unknown 列表 + 依赖关系
- `001.md - 005.md` — 详细 task 分解

调研细节可被 N1 实施时引用。但**不再作为权威 task 列表**。

---

如要推进 N1 Team Validation Hooks，请按新计划 §4.3 + §5 启动顺序执行。
