"""ACP approval bridge (extracted from shadowflow.runtime.acp.approval_bridge).

Bridges ACP session.requestPermission to ShadowFlow's approval_gate mechanism.
The class is moved here verbatim; the original module re-exports it for
