...
const builtinNodes: INode[] = [
  // ========== 输入节点 ==========
  {
    ...
    category: 'input',
    icon: '📥',
    color: 'var(--t-run, var(--t-info, var(--t-accent)))',
    accentColor: 'var(--t-run, var(--t-info, var(--t-accent)))',
    inputs: [],
    outputs: [
  ...
  // ========== 规划节点 ==========
  {
    ...
    icon: '📊',
    color: 'var(--t-accent)',
    accentColor: 'var(--t-accent-bright, var(--t-accent))',
    inputs: [
  ...
  // ========== 协调节点 ==========
  {
    ...
    category: 'coordinate',
    icon: '⚡',
    color: 'var(--t-gated, var(--t-accent))',
    accentColor: 'var(--t-gated, var(--t-accent))',
    inputs: [
