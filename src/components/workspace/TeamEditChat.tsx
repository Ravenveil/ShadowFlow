  ...
  if (!expanded) {
    return (
      ...
      >
        ...
        <span style={{ fontSize: 12, color: 'var(--t-fg-4)' }}>对话修改 Team ... 说"改名为..."、"加一个 agent"、"改描述"</span>
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ flex: 1 }} />
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'var(--t-fg-5)' }}>用自然语言修改 Team 配置</span>
        <button
